...
?>
 ...
 <div class="contenuGestionNotes">
        ...
        <div class="ensembleBouttonListe">
            <a class="bouttonListe" id="bouttonListe1" type="submit" href="index.php?action=adminNotesForm&m=ajout">Ajouter une note</a>
        </div>
    </div>
    ...
    <table id="tableFormulaire">
        <thead>
            <tr>
                ...
                <th class="titreTh" id="traitTh">Note</th>
                <th class="titreTh">Action</th>
            </tr>
        </thead>
    <?php
    $notes = SuiviManager::getListMatiere($matiere->getidMatiere());
    foreach($notes as $n){
        echo'<tbody>
        <tr>
