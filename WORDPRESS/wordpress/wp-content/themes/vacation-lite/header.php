...
<section id="home_slider">
  <div class="slider-wrapper theme-default">
    ...
    <div id="slidecaption<?php echo esc_attr( $vacation_lite_sln ); ?>" class="nivo-html-caption">
      <div class="top-bar">
      ...
      <section class="menu_page">
            	<div class="container">
                    <div class="services">
                        ...
                        <?php if($hidetitle == '') { ?>
                    	<h2 class="section-title"><?php echo esc_attr(get_theme_mod('welcome_title',__('Planing Your Next Vacation','vacation-lite'))); ?></h2>
                        <div class="section-subtitle"><?php echo esc_attr(get_theme_mod('welcome_subtitle',__('Ready to plan your next getway? Get advice from Vacation','vacation-lite'))); ?></div>
                        <?php } ?>
         		...
         		<?php while( $page_query->have_posts() ) : $page_query->the_post(); ?>
                         <div id="services-box" <?php if($f%3==0) { ?>class="last"<?php } ?>>
                         		<div class="services-inner">
									...
									<h2><?php the_title(); ?></h2>				
									<p><?php the_excerpt(); ?></p>
									<a href="<?php the_permalink(); ?>" class="check"><?php esc_attr_e('Check Availability','vacation-lite'); ?></a>				
								</div>
                       </div>
                       <?php endwhile; ?>
                       <?php } } } ?>
